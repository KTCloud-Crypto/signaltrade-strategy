...
class MessageEnvelope(BaseModel):
    """Versioned inter-service message envelope compatible with signaltrade-core."""
    ...
    def create(cls, *, message_type: str, producer: str, payload: dict[str, Any],
               ...
               idempotency_key: str | None = None) -> "MessageEnvelope":
        message_id = uuid4()
    ...
    @classmethod
    def from_json(cls, value: str | bytes) -> "MessageEnvelope":
